  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 flex min-h-0 flex-1 flex-col pb-3'>
        <header className='px-4 py-6 w-full bg-black/10 rounded-2xl border-b-1 border-b-gray-900'>
          <div className='h-9 w-48 rounded-lg bg-gradient-to-r from-zinc-800 via-zinc-700 to-zinc-800 shimmer m-1' />
